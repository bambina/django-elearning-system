...
class QASessionModelTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.course = CourseFactory.create()
        cls.room_name = "1_20240801000000000000_12345678"
    ...
    def test_create_qa_session(self):
        ...
        self.assertEqual(self.qa_session.room_name, self.room_name)
    ...
    def test_field_constraints(self):
        ...
        room_name_unique = QASession._meta.get_field("room_name").unique
        self.assertTrue(room_name_unique)
